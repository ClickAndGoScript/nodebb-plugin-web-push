			...
			<form role="form" class="web-push-settings">
				<div class="mb-4">
					...
					<div class="mb-3 form-check form-switch">
						...
						<label class="form-check-label" for="promptEnabled">{{tx("web-push:admin.prompt-enabled")}}</label>
						<p class="form-text">{{tx("web-push:admin.prompt-enabled-help")}}</p>
					</div>

					<div class="mb-3">
						<label class="form-label" for="promptDelay">{{tx("web-push:admin.prompt-delay")}}</label>
						<input type="number" min="1" max="100" id="promptDelay" name="promptDelay" title="{{tx("web-push:admin.prompt-delay")}}" class="form-control" placeholder="3">
						<p class="form-text">{{tx("web-push:admin.prompt-delay-help")}}</p>
					</div>
				</div>
			</form>
